...
foreach(_expectedTarget ur_client_library::urcl)
...
# Create imported target ur_client_library::urcl
add_library(ur_client_library::urcl SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/urclTargets-*.cmake")
